...
::: {.callout-note}
For a comprehensive overview of the webbook, we have a [webinar](https://zenodo.org/records/16813426) that covers all chapters and how to contribute [@kmiecikMJFFDataCommunity2025]. Slides for the webinar are available [here](images/osg-slides.pdf).
:::
